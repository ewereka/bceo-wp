  ...
  */
  ...
  private static function create_acf_pages() {
    if( function_exists('acf_add_options_page') ) {
      ...
      acf_add_options_sub_page(array(
        'page_title' 	=> 'BCEO Header Settings',
        'menu_title'	=> 'Header',
        'parent_slug'	=> 'bceo-theme-settings',
      ));
      
      acf_add_options_sub_page(array(
        'page_title' 	=> 'BCEO Footer Settings',
        'menu_title'	=> 'Footer',
        'parent_slug'	=> 'bceo-theme-settings',
      ));

      acf_add_options_sub_page(array(
        'page_title' 	=> 'BCEO Content Type Settings',
  ...
  private static function create_post_types()
  {
    ...
    $faq_type_args =            array(
      ...
      "show_in_admin_bar"       => true,
      "query_var"               => true,
      "rewrite"                 => array( "slug" => $faq_slug, "with_front" => false ),
      "capability_type"         => "post",
      "has_archive"             => true,
      "hierarchical"            => false,
      "menu_position"           => 20,
    ...
    $projects_type_args =       array(
      ...
      "show_in_admin_bar"       => true,
      "query_var"               => true,
      "rewrite"                 => array( "slug" => $projects_slug, "with_front" => false ),
      "capability_type"         => "post",
      "has_archive"             => true,
      "hierarchical"            => false,
      "menu_position"           => 21,
    ...
    $faq_collection_taxonomy_args = array(
      ...
      "query_var"         => true,
      "rewrite"           => array( "slug" => $faq_collection_taxonomy_name ),
    );
    ...
    $project_status_taxonomy_args = array(
      ...
      "show_admin_column" => true,
      "query_var"         => true,
      "rewrite"           => array( "slug" => $project_status_taxonomy_slug ),
    );
    ...
    $project_location_taxonomy_args = array(
      ...
      "show_admin_column" => true,
      "query_var"         => true,
      "rewrite"           => array( "slug" => $project_location_taxonomy_slug ),
    );

    register_taxonomy( $faq_collection_taxonomy_name, array( $faq_type_name ), $faq_collection_taxonomy_args );
    register_taxonomy( $project_status_taxonomy_name, array( $projects_type_name ), $project_status_taxonomy_args );
    register_taxonomy( $project_location_taxonomy_name, array( $projects_type_name ), $project_location_taxonomy_args );
