...
function ewereka_load_scripts() {
  ...
  wp_enqueue_style( 'ewereka-icons', get_template_directory_uri() . '/font/vendor/fontawesome/css/all.min.css', array('style') );
  wp_enqueue_style( 'ewereka-style', get_template_directory_uri() . '/css/main.css', array('style', 'ewereka-icons') );
  wp_enqueue_script( 'jquery' );
  wp_enqueue_script( 'ewereka-scripts', get_template_directory_uri() . '/js/dist/main.js', array('jquery'), null, true);
}
...
add_filter( 'intermediate_image_sizes_advanced', 'ewereka_image_insert_override' );
...
function ewereka_widgets_init() {
  register_sidebar( array(
    'name' => esc_html__( 'Sidebar Widget Area', 'com.ewereka.bceo.theme' ),
