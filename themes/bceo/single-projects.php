          ...
          ?>
            <article <?php post_class('blog-post'); ?>>
              ...
              <header class="entry-header">
                <?php if (get_field('funding')): ?><h4 class="my-0">Funding: <?php the_field('funding'); ?><?php endif; ?>
                <?php if (get_field('start_date')): ?><h4 class="my-0">Funding: <?php the_field('start_date'); ?><?php endif; ?>
              </header>
