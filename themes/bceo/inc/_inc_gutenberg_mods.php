...
function ewereka_gutenberg_scripts() {
	wp_enqueue_script( 'ewereka-gutenberg-scripts', get_stylesheet_directory_uri() . '/js/dist/editor.js', array( 'wp-blocks', 'wp-dom' ), get_stylesheet_directory() . '/assets/js/editor.js', true );
}
